...
class ManageDataHandler(webapp.RequestHandler):
  ...
  def QueryToData(self, query):
    query_template = """<div class="lt-query">
      ...
      <p class='new-entry'><a class='new-entry-button' id='new-entry-button-%(query_id)s' href="#">New entry</a> <a class='new-entry-submit-button' id='new-entry-submit-button-%(query_id)s' href='#'>Submit</a></p>
    </div>"""
